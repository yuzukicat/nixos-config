...

{
  ...
  nixpkgs.config.permittedInsecurePackages = drv:
  ...
  fileSystems = {
    "/" = {
      device = "/dev/disk/by-uuid/87bbd1d7-8ee3-4a07-8a5c-989d76ead4be";
      fsType = "btrfs";
      # zstd:1  W: ~510MiB/s
      # zstd:3  W: ~330MiB/s
    ...
    "/boot" = {
      device = "/dev/disk/by-uuid/72F9-AAD0";
      fsType = "vfat";
    };

    "/home" = {
      device = "/dev/disk/by-uuid/52426235-3048-47b9-a2ec-13e474a20f04";
      fsType = "btrfs";
      # zstd:1  W: ~510MiB/s
      # zstd:3  W: ~330MiB/s
      # options = [ "relatime" "compress=zstd:1" "subvol=@" "nofail"];
