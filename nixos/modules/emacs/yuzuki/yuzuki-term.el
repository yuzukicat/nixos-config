;;; yuzuki-term --- terminal configuration
;;; Commentary:
...
(defun yuzuki-vterm-auto-rename-send-return ()
...
(define-key vterm-mode-map [return] 'yuzuki-vterm-auto-rename-send-return)
(setq multi-vterm-buffer-name "vterm")
;; (add-hook 'vterm-mode-hook 'yuzuki-vterm-auto-rename)

(provide 'yuzuki-term)
;;; yuzuki-term.el ends here.
